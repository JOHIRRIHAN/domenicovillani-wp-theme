...
<aside class="nymia-sidebar">
    ...
    <div class="nymia-logo">
        <a href="<?php echo home_url('/'); ?>">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/dashboardLogo-Bt6G_8pS.png" alt="Nymia Logo" />
        </a>
    </div>
    ...
    <nav class="nymia-nav">
        ...
        <a href="<?php echo home_url('/live-audio'); ?>" class="nymia-nav-item <?php echo is_page('live-audio') ? 'active' : ''; ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo home_url('/pdf'); ?>" class="nymia-nav-item<?php echo is_page('pdf') ? ' active' : ''; ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
